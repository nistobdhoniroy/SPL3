...
class Customer(models.Model):
    ...
    fullname = models.CharField(max_length=100, default='test name')

    address1 = models.CharField(max_length=200, blank=True, null=True, default='test')
    address2 = models.CharField(max_length=200, blank=True, null=True, default='test')

    phone_regex = RegexValidator(regex=r'^\+?1?\d{9,15}$',
                                 message="Phone number must be entered in the format: '+01789416541'. Up to 14 digits allowed.")
    phone_number = models.CharField(validators=[phone_regex], max_length=14,
                                    blank=True, default='+01456433')  # validators should be a list
