...
from .custom_functions import get_similar_products, get_real_vendor_similar_prods, recommendation_product, searchOtherProduct, searchProduct
...
class SearchItem(View):
    def get(self, request, format=None):
        ...
        search_prod_result = searchProduct(query)
        search_prod_result_from_others = searchOtherProduct(query)

        print(search_prod_result)
        print(search_prod_result_from_others)
        ...
        context = {
            'same_products': search_prod_result,
            'similar_products_real_vendor': search_prod_result_from_others
        }
